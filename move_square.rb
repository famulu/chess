def move_square(piece_square, new_x, new_y, undone_square, board)
  ...
  board[piece_square.y][piece_square.x] = (undone_square == nil ? BoardSquare.new(piece_square.y, piece_square.x, nil) : undone_square)
...
def move_square_okay?(initial_square, final_square, board, king)
  ...
  move_square(initial_square, final_square.x, final_square.y, nil, board)
